#usr/bin/env python  """  Here are some examples to wet your appetite.  To run them, use the number as arg, eg.  $ ./tutorial.py 5  Make sure the volume is turned down first!  """
  from Sonic import *

  def test00():
    # play a sin wave
    sin = Sin() # make a task
    sin | Dsp() # connect it to a soundcard task
    while 1:
